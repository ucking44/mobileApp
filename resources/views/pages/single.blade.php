        ...
        <div class="col-md-9">
            <div class="thumbnail">
             <img class="img-responsive img-thumbnail" src="{{ asset('uploads/products/' .  $product->product_image) }}" style="height: 300px; width: 700px;" alt="">
              ...
              <div class="caption-full">
                  <h4 class="pull-right">${{ number_format($product->product_price, 2) }}</h4>
                  <h4><a href="{{url('products/'. $product->product_id)}}">{{$product->product_name}}</a></h4>
            ...
            <div class="well" id="reviews-anchor">
              ...
              <div class="text-right">
                <a href="{{ URL::to('/view_product', $product->product_id)}}" id="open-review-box" class="btn btn-success btn-green">Leave a Review</a>
              </div>
              <div class="row" id="post-review-box" style="display:none;">
                <div class="col-md-12">
                  {{Form::open()}}
                  {{Form::hidden('rating', null, array('id'=>'ratings-hidden'))}}
                  {{-- <textarea class="form-control" placeholder="Enter Your Review Here ......"></textarea>  --}}
                  {{Form::textarea('review', null, array('rows'=>'5','id'=>'new-review','class'=>'form-control animated','placeholder'=>'Enter your review here...'))}}
                  <div class="text-right">
...
@section('scripts')
  ...
  <script type="text/javascript">
    $(function(){
      ...
      @if($errors->first('review') || $errors->first('rating'))
        openReviewBtn.click();
      @endif
