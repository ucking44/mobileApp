<style>
    ...
    @section('content')
        ...
        {{-- <h2>{{$product->body}}</h2> --}}
        <br>
        {{-- <img src="{{$product->image}}" height="350" width="350"> --}}
        <div class= 'Info'>
        <br>
        <b>
       {{-- Distance from University- {{$product->distance}}
        <br>
       Number of Rooms - {{$product->rooms}}
        <br>
     ...
     @can('isUser')
        ...
        @if(count($review) > 1)
            @foreach($review as $reviews)
                <div class= "well">
                    <h3><a href="/reviews/{{$reviews->customer_name}}">{{$reviews->customer_name}} </a></h3><small>{{$reviews->created_at}}</small><br>
                    <small>{{$reviews->review}}</small>
                   <br>
                   <br>
                </div>
