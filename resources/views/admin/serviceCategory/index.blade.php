    ...
    <!-- /.content-header -->
     ...
     <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <a href="{{ URL::to('/create/service-category') }}" class="btn btn-primary">Create Service Category</a>
                    @include('layouts.backend.partials.msg')
                        <div class="card">
                            <div class="card-header card-header-primary">
                            <h4 class="card-title "><b>All Service Categories</b></h4>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="table" class="table table-striped table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            @foreach ($serviceCates as $category)
                                                <tr>
                                                    {{-- <td>{{ $key + 1 }}</td> --}}
                                                    <td>{{ $category->id }}</td>
                                                    ...
                                                    <td style="text-align: center;">
                                                        @if ($category->status == 'enable')
                                                        <a href="{{ URL::to('/service/unactive_category/' . $category->id)}}">
                                                            <span class="badge badge-warning">Inactive</span>
                                                            {{-- <i class="halflings-icon white thumbs-down">in-active</i> --}}
                                                        </a>
                                                        @else
                                                        <a href="{{ URL::to('/service/active_category/' . $category->id)}}">
                                                            <span class="badge badge-success">Active</span>
                                                            {{-- <i class="halflings-icon white thumbs-up">active</i> --}}
                                                        </a>
                                                        @endif
                                                        <a href="{{ URL::to('/edit/service-category/' . $category->id)}}">
                                                            <span class="badge badge-info">Edit</span>
                                                            {{-- <i class="halflings-icon white edit">edit</i> --}}
                                                        </a>
                                                        <a href="{{ URL::to('/delete/service-category/' . $category->id)}}" id="delete">
