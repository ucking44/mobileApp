                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header card-header-primary">
                            <h4 class="card-title "><b>Edit Service</b></h4>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="fee" value="{{ $service->fee }}" required="">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="duration" value="{{ $service->duration }}" required="">
                                        </div>
                                    </div>
                                </div>

                                <a href="{{ URL::to('/service') }}" class="btn btn-warning">Back</a>
